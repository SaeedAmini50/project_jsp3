...
PreparedStatement ps = con.prepareStatement("INSERT INTO product (product_name,product_price,product_size,product_attribute,product_mark,product_photo,product_active,product_benefit,category_ID) values(?,?,?,?,?,?,?,?,?);");
